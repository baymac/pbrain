...
├── lib/reminders.sh                    ← reminder notify/tick/surfacing (pbrain_notify, pbrain_notify_build, pbrain_reminders_*) + blocking-overlay build/show (pbrain_overlay_build, pbrain_overlay_show; tick dispatches block_seconds rows to the overlay)
