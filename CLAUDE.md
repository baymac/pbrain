...
| `agent-work/daily-grooming/` | `/project-manager groom` outputs (PB-94) — per-day grooming data: triage info, the auto-exec queue, and the execute loop's auto-work outcomes. iCloud-synced for morning review. One `<date>.md` per day. |
