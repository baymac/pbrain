...
| `/end-of-day` | `$VAULT_DIR/life/daily-planning/<date>-close.md` (sibling of the plan file) | `PBRAIN_PLAN_DIR` (write target), `PBRAIN_JOURNAL_DIR`, `PBRAIN_FITNESS_DIR`, `PBRAIN_DIET_DIR` for cross-ref |
